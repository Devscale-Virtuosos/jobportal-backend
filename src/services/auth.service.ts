...
const AuthServices = {
  ...
  // validateGoogleAuthorization: async (
  //   code: string,
  //   codeVerifier: string,
  //   role: string
  // ) => {
  ...
  //     let tokenPayload: TTokenPayload = null;
  ...
  //     accessToken = jwt.sign(tokenPayload, env.ACCESS_TOKEN_SECRET, {
  //       expiresIn: env.ACCESS_TOKEN_EXPIRES_TIME,
  //     });
  //     refreshToken = jwt.sign(tokenPayload, env.REFRESH_TOKEN_SECRET, {
